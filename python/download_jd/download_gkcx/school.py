...
batchTypes = ["10036","10038","10148","10037","10149"]
proxyBean={"ip":"114.215.117.222", "port":36666}
	...
	while(hasNext):
		...
		for item in ret["school"]:
			try:
				...
				print csv
				content += csv + "\n"
				C.appendFile("d:\\temp\\d3\\abcd\\" + typeName + ".csv", content)
			except Exception  as e:
				print e		

	C.appendFile("d:\\temp\\d3\\abcd\\" + typeName + "_all.csv", content)
...
tts=["putongbenke", "dulixunyuan", "gaozhi"]
schoolTypes = ["%E6%99%AE%E9%80%9A%E6%9C%AC%E7%A7%91", "%E7%8B%AC%E7%AB%8B%E5%AD%A6%E9%99%A2","%E9%AB%98%E8%81%8C%E9%AB%98%E4%B8%93"]
