...
## copy form  https://blog.csdn.net/wodeyan001/article/details/82497564?utm_medium=distribute.pc_relevant_ask_down.none-task-blog-baidujs-1.nonecase&depth_1-utm_source=distribute.pc_relevant_ask_down.none-task-blog-baidujs-1.nonecase
...
class _Main:  #调用SysTrayIcon的Demo窗口
    ...
    def switch_icon(s, _sysTrayIcon, icon = 'favicon02.ico'):
    ...
    def Hidden_window(s, icon = 'favicon01.ico', hover_text = "SysTrayIcon.py Demo"):
